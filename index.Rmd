...
### *Example realization of synthetic data 1*
...
.pull-right-narrow[Prediction error (RMSE above and MAE below) over 30 repeated samples.]


---
## Empirical comparison using synthetic data with EpiEstim

### *Example realization of synthetic data 2* (when smoothing assumption is violated)
...
### *Example realization of synthetic data 3* (when Poisson assumption is violated)
